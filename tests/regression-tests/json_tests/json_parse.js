...
if (props.length != 1)
  $ERROR("#76:error")
if (props[0] != "JSON Test Pattern pass3")
  $ERROR("#77:error")
if (typeof (x["JSON Test Pattern pass3"]) != "object")
  $ERROR("#78:error")
props = Object.getOwnPropertyNames(x["JSON Test Pattern pass3"]).sort();
if (props.length != 2)
  $ERROR("#79:error");
if (props[0] != "In this test")
  $ERROR("#80:error");
if (props[1] != "The outermost value")
  $ERROR("#81:error");
if (x["JSON Test Pattern pass3"]["The outermost value"] != "must be an object or array.")
  $ERROR("#82:error");
if (x["JSON Test Pattern pass3"]["In this test"] != "It is an object.")
  $ERROR("#83:error")
