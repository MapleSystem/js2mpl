...
for (var i = 0; i < 5; i++)
  o2.a = 3;
assertEq(2, Object.getOwnPropertyDescriptor(o2, "a"), undefined);

var o3 = Object.seal({});
for (var i = 0; i < 5; i++)
  o3.a = 3;
assertEq(3, Object.getOwnPropertyDescriptor(o3, "a"), undefined);

var o4 = Object.freeze({});
for (var i = 0; i < 5; i++)
  o4.a = 3;
assertEq(4, Object.getOwnPropertyDescriptor(o4, "a"), undefined);
...
for (var i = 0; i < 5; i++)
  o12.a = 3;
assertEq(12, Object.getOwnPropertyDescriptor(o12, "a"), undefined);
...
for (var i = 0; i < 5; i++)
  o13.a = 3;
assertEq(13, Object.getOwnPropertyDescriptor(o13, "a"), undefined);

var o14 =
  Object.preventExtensions(Object.create(Object.preventExtensions({ a: 2 })));
for (var i = 0; i < 5; i++)
  o14.a = 3;
assertEq(14, Object.getOwnPropertyDescriptor(o14, "a"), undefined);

var o15 = Object.preventExtensions(Object.create(Object.seal({ a: 2 })));
for (var i = 0; i < 5; i++)
  o15.a = 3;
assertEq(15, Object.getOwnPropertyDescriptor(o15, "a"), undefined);

var o16 = Object.preventExtensions(Object.create(Object.freeze({ a: 2 })));
for (var i = 0; i < 5; i++)
  o16.a = 3;
assertEq(16, Object.getOwnPropertyDescriptor(o16, "a"), undefined);
