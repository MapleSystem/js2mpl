...
foreach $srcdir (@required) {
  if(-d $srcdir) {
    ...
    foreach $fullname (@files) {
      ...
      my $res = system("$pwd/../../out/target/product/maple_arm32-gnu-release/bin/js2mpl $plugindir/$js_file $option > $plugindir/$log_file");
      if ($res > 0) {
        print " ==js2mpl===> $file\n";
        $countMPL ++;
      ...
      $res = system("$pwd/../../out/target/product/maple_arm32-gnu-release/bin/mplme $plugindir/$mpl_file >> $plugindir/$log_file");
      if ($res > 0) {
        print " ==mplme===> $file\n";
        $countME ++;
      ...
      $res = system("$pwd/../../out/target/product/maple_arm32-gnu-release/bin/mplbe $plugindir/$mpl_file >> $plugindir/$log_file");
      if ($res > 0) {
        print " ==mplbe===> $file\n";
        $countMMPL ++;
      ...
      $res = system("$pwd/../../out/target/product/maple_arm32-gnu-release/bin/mplbe-c $plugindir/$mpl_file >> $plugindir/$log_file");
      if ($res > 0) {
...
#      $res = system("$pwd/../../out/target/product/maple_arm32-gnu-release/bin/cmpl2mmpl $plugindir/$cmpl_file >> $plugindir/$log_file");
#      if ($res > 0) {
...
while( ($srcdir = readdir(DIR))){
  if(-d $srcdir and $srcdir ne ".." and $srcdir ne "output" and $srcdir ne "temp") {
    ...
    foreach $fullname (@files) {
      ...
      my $res = system("$pwd/../../out/target/product/maple_arm32-gnu-release/bin/js2mpl $tempdir/$js_file $option > $tempdir/$log_file");
      if ($res > 0) {
        print " ==js2mpl===> $file\n";
        $countMPL ++;
        push(@failed_mpl_file, $file);
      ...
      $res = system("$pwd/../../out/target/product/maple_arm32-gnu-release/bin/mplme $tempdir/$mpl_file >> $tempdir/$log_file");
      if ($res > 0) {
        print " ==mplme===> $file\n";
        $countME ++;
        push(@failed_mplme_file, $file);
      ...
      $res = system("$pwd/../../out/target/product/maple_arm32-gnu-release/bin/mplbe $tempdir/$mpl_file >> $tempdir/$log_file");
      if ($res > 0) {
        print " ==mplbe===> $file\n";
        $countMMPL ++;
        push(@failed_mmpl_file, $file);
      ...
      $res = system("$pwd/../../out/target/product/maple_arm32-gnu-release/bin/mplbe-c $tempdir/$mpl_file >> $tempdir/$log_file");
      if ($res > 0) {
        print " ==mplbe-c===> $file\n";
        $countgenCMPL ++;
        push(@failed_gencmpl_file, $file);
...
#      $res = system("$pwd/../../out/target/product/maple_arm32-gnu-release/bin/cmpl2mmpl $tempdir/$cmpl_file >> $tempdir/$log_file");
#      if ($res > 0) {
#        print " ==cmpl2mmpl===> $file\n";
#        $countprintCMPL ++;
#        push(@failed_printcmpl_file, $file);
...
#        next;
#      }
#      $res = system("cd $tempdir; $pwd/timeout.sh -t 1 -i 1 -d 0 $pwd/../../out/target/product/maple_arm32-gnu-release/bin/jsvm-cmpl $cmpl_file >> $tempdir/$log_file");
#      if ($res > 0) {
...
#      }
      ...
      $res = system("cd $tempdir; $pwd/../../out/target/product/maple_arm32-gnu-release/bin/interpreter $mmpl_file > $tempdir/$out_file");
